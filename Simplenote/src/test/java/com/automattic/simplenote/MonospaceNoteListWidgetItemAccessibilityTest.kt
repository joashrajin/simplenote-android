...
class MonospaceNoteListWidgetItemAccessibilityTest {
    @Test
    fun lightWidgetStatusIconsUseTheirOwnLabels() {
        assertStatusIconLabels(R.layout.note_list_widget_item_light_monospace)
    }

    @Test
    fun darkWidgetStatusIconsUseTheirOwnLabels() {
        assertStatusIconLabels(R.layout.note_list_widget_item_dark_monospace)
    }
