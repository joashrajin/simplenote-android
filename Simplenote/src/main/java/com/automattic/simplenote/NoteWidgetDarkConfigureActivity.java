...
public class NoteWidgetDarkConfigureActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mRemoteViews = new RemoteViews(getPackageName(), PrefUtils.getLayoutWidget(this, false));
    ...
    private void completeWidget(WidgetNotePickerSelection note) {
        ...
        mRemoteViews.setTextColor(R.id.widget_text, getColor(R.color.text_title_dark));
        mRemoteViews.setTextViewText(R.id.widget_text_title, title);
        mRemoteViews.setTextColor(R.id.widget_text_title, getColor(R.color.text_title_dark));
