...
class DefaultNoteListWidgetItemAccessibilityTest {
    @Test
    fun lightWidgetStatusIconsUseTheirOwnLabels() {
        assertStatusIconLabels(R.layout.note_list_widget_item_light)
    }

    @Test
    fun darkWidgetStatusIconsUseTheirOwnLabels() {
        assertStatusIconLabels(R.layout.note_list_widget_item_dark)
    }
